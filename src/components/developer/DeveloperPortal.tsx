...
import { 
  ...
  HardDrive, FileText, Folder, User, LogOut, Bot, Github
} from 'lucide-react';
...
import AiApiManagement from '@/components/developer/AiApiManagement';
import NetlifyDeployments from '@/components/developer/NetlifyDeployments';
import GitHubManagement from '@/components/developer/GitHubManagement';
...
const menuItems = [
  ...
  { id: 'ai-apis', label: 'AI APIs', icon: Bot, component: AiApiManagement },
  { id: 'deployments', label: 'Netlify Deploy', icon: Globe, component: NetlifyDeployments },
  { id: 'github', label: 'GitHub Tokens', icon: Github, component: GitHubManagement },
